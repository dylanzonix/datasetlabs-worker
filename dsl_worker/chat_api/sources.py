...
SOURCE_TOOLS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": (
            "First move for ANY named platform (Reddit, X, LinkedIn, "
            "YouTube, Zillow, Etsy, GitHub, TikTok, Instagram, Upwork, "
            "etc.). Run an Apify actor — candidates file lands with "
            "a sample of items + the actor's output fields. Then "
            "`candidates_to_rows(file, column_map, confirm=true)` "
            "commits rows and streams the rest into the table live "
            "as the actor finishes. Same pattern as every source tool.\n\n"
