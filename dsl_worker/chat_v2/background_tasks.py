...
def _emit_run_event(
    ...
    try:
        ...
        if run_obj is not None:
            legacy_runs.emit_event(db, run_obj, etype, payload)
    except Exception:
...
async def spawn(
    ...
    *immediately* — the actual work runs in an asyncio.Task that
    ...
    async def _runner() -> None:
        ...
        from dsl_worker.chat_v2.tools import ToolContext as _Ctx
        ...
        try:
            ...
            try:
                ...
                if cost_usd and cost_usd > 0:
                    try:
                        from dsl_worker.chat_v2.runs import _charge_run_credits
